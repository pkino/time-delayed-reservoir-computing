function trialSeriTDRC(order,seriNum)
dbstop if error
trial=100; Task='NARMA'; theta=0.2; learnDimension=400; biasCheck=0; inputCheck=0; p=3;
diffMask=1;
...
RCLen=1500; % 最終の学習の長さ
oneSeriSteps = 200;  dataLen = RCLen+seriNum*oneSeriSteps; %oneSteps=l_Start(TDRC内の変数)と設定
